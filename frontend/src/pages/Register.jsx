      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <GlassInput
            ...
            className="bg-white/10"
          />
          <p className="text-xs text-gray-400 mt-1 pl-1">Minimum 6 characters</p>
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-primary text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-neon-purple transition-all duration-300 flex items-center justify-center group disabled:opacity-50 disabled:cursor-not-allowed mt-6"
          >
            {loading ? (
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-300">
            ...
            <Link to="/login" className="text-orbit-blue hover:text-orbit-blue-light font-semibold hover:underline">
              Sign in
            </Link>
          </p>
        </div>
